...
# asimov_lalinference is one of those entry-points, so importing it while
...
project = "asimov-lalinference"
copyright = "2026, Daniel Williams"
author = "Daniel Williams"

try:
    from importlib.metadata import version as _get_version
    release = _get_version("asimov-lalinference")
except Exception:
    release = "unknown"
...
html_theme_options = {
    "navbar_title": "asimov-lalinference",
}
